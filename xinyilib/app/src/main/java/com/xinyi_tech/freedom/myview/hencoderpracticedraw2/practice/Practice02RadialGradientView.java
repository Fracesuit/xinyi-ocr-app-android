...
public class Practice02RadialGradientView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        RadialGradient gadialGradient = new RadialGradient(300, 300, 200, Color.parseColor("#E91E63"), Color.parseColor("#2196F3"), Shader.TileMode.CLAMP);
        paint.setShader(gadialGradient);
