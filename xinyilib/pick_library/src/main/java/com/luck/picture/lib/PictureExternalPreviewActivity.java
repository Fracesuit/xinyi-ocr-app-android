...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
        ...
        btn_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isHttp) {
                    ...
                    // 有可能本地图片
                    try {
                        String dirPath = getFile();
                        FileUtils.copyFile(path, dirPath, new FileUtils.OnReplaceListener() {
                            @Override
    ...
    private String getFile() {
        String absolutePath = PictureFileUtils.getRootDir(directory_path).getAbsolutePath();
        String fileName = PictureFileUtils.getFileName(".png");
        return PictureFileUtils.createFile(absolutePath, fileName).getAbsolutePath();
    }
