...
public class ConfigurationProviderImpl implements ConfigurationProvider {
    ...
    protected int mediaQuality = Configuration.MEDIA_QUALITY_HIGHEST;

    @Configuration.MediaQuality
    protected int passedMediaQuality = Configuration.MEDIA_QUALITY_HIGHEST;
    ...
    protected int coverType = Configuration.COVERTYPE_NONE;
    ...
    public void setupWithAnnaConfiguration(Configuration configuration) {
        if (configuration != null) {
            ...
            setCustomCameraCover(configuration);

            setMediaPath(configuration.getMediaPath());
            setMediaName(configuration.getMediaName());
            setFaceDetection(configuration.isFaceDetection());
    ...
    private void setCustomCameraCover(Configuration configuration) {
        this.coverType = configuration.getCoverType();
