package com.xinyi_tech.freedom.myview.hencoderpracticedraw3;
...
public class TextActivity extends AppCompatActivity {
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_measure_text, R.string.title_measure_text, R.layout.practice_measure_text3));
