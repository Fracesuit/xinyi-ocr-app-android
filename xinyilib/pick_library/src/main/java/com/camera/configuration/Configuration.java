...
public final class Configuration implements Serializable {
    ...
    public static final int COVERTYPE_NONE = -1;
    public static final int COVERTYPE_FACE = 1;//单纯的头像
    public static final int COVERTYPE_RECTANGLE = 2;//矩形
    public static final int COVERTYPE_SMART_FACE = 3;//智能头像
    ...
    @IntDef({COVERTYPE_NONE, COVERTYPE_FACE, COVERTYPE_RECTANGLE, COVERTYPE_SMART_FACE})
    @Retention(RetentionPolicy.SOURCE)
    ...
    @CoverType
    private int coverType = COVERTYPE_NONE;
    ...
    public static class Builder {
        ...
        public Builder(String mediaPath, String mediaName) {
            configuration = new Configuration();
            configuration.mediaPath = mediaPath;
            configuration.mediaName = mediaName;
        }
        ...
        public Builder setFaceDetection(boolean faceDetection) {
        ...
        public Builder setCoverType(@CoverType int coverType) {
            configuration.coverType = coverType;
            return this;
        }
