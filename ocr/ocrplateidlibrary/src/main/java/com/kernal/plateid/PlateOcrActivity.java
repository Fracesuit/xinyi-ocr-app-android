...
public class PlateOcrActivity extends Activity implements OnClickListener{
...
//            	pap.versionfile = PATH+"/AndroidWT/wtversion.lsc";
    ...
    protected void onCreate(Bundle savedInstanceState) {   
        ...
        PlateProjectTool.addActivityList(PlateOcrActivity.this);
        findViews();
...
//        setButton = (Button) findViewById(R.id.butset);
    ...
    public void onClick(View v) {
		...
		if(getResources()
			...
			Intent cameraintent = new Intent(PlateOcrActivity.this,MemoryCameraActivity.class);
        	if (Build.VERSION.SDK_INT >= 23) {
				CheckPermission checkPermission = new CheckPermission(PlateOcrActivity.this);
				if (checkPermission.permissionSet(PERMISSION)) {
				PermissionActivity.startActivityForResult(PlateOcrActivity.this,0,"false",  PERMISSION);
				} else {
			...
			if (Build.VERSION.SDK_INT >= 23) {
    				CheckPermission checkPermission = new CheckPermission(PlateOcrActivity.this);
    				if (checkPermission.permissionSet(PERMISSION)) {
    					PermissionActivity.startActivityForResult(PlateOcrActivity.this,0,"AuthService",  PERMISSION);
    				}
        	...
        	if (Build.VERSION.SDK_INT >= 23) {
				CheckPermission checkPermission = new CheckPermission(PlateOcrActivity.this);
				if (checkPermission.permissionSet(PERMISSION)) {
					PermissionActivity.startActivityForResult(PlateOcrActivity.this,0,"choice",  PERMISSION);
				} else {
					try {
...
//        switch (v.getId()) {
//        case R.id.butset:
//            Intent intent = new Intent(PlateOcrActivity.this, PlateIDCfg.class);
...
//        			&& readIntPreferences("PlateService","preWidth") != 0 && readIntPreferences("PlateService","preHeight") != 0
//        					&& readIntPreferences("PlateService","preMaxWidth") != 0 && readIntPreferences("PlateService","preMaxHeight") != 0) {
//                Intent camera_intent = new Intent(PlateOcrActivity.this, CameraActivity.class);
...
//
	...
	*/
	private void CreatDialog() {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(PlateOcrActivity.this);
//        builder.setIcon(R.drawable.ic_launcher);
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
            	...
            	video_intent = new Intent(PlateOcrActivity.this,MemoryCameraActivity.class);
            	if (Build.VERSION.SDK_INT >= 23) {
    				CheckPermission checkPermission = new CheckPermission(PlateOcrActivity.this);
    				if (checkPermission.permissionSet(PERMISSION)) {
    					PermissionActivity.startActivityForResult(PlateOcrActivity.this,0,"true",  PERMISSION);
...
//            	startActivity(video_intent);           	
   ...
   public void CreatViewtoAuthservice(){
	   	...
	   	editText.setTextColor(Color.BLACK);
			new  AlertDialog.Builder(PlateOcrActivity.this)
			...
			.setPositiveButton(R.string.license_verification, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
		            ...
		            Intent authIntent = new Intent(PlateOcrActivity.this, AuthService.class);
