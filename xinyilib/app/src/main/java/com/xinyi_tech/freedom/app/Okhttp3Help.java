...
import com.xinyi_tech.freedom.app.okhttp.SPCookieStore;
...
public class Okhttp3Help {
    ...
    public static OkHttpClient.Builder getOkHttpClientBuilder() {
        ...
        final SPCookieStore spCookieStore = new SPCookieStore(Utils.getApp());
               ...
               .addInterceptor(new HeadInterceptor())
                ...
                .cookieJar(new CookieJar() {
                    ...
                    public void saveFromResponse(HttpUrl httpUrl, List<Cookie> list) {
                        spCookieStore.saveCookie(httpUrl, list);
                    }

                    @Override
                    public List<Cookie> loadForRequest(HttpUrl httpUrl) {
                        List<Cookie> cookies = spCookieStore.getCookie(httpUrl);
