package com.xinyi_tech.freedom.myview.hencoderpracticedraw3.practice;
...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // int middle = (top + bottom) / 2;
        ...
        heights[0]=(rect.bottom+rect.top)/2;

        paint2.getTextBounds(text2,0,text2.length(),rect);
        heights[1]=(rect.bottom+rect.top)/2;

        paint2.getTextBounds(text3,0,text3.length(),rect);
        heights[2]=(rect.bottom+rect.top)/2;

        paint2.getTextBounds(text4,0,text4.length(),rect);
        heights[3]=(rect.bottom+rect.top)/2;

        paint2.getTextBounds(text5,0,text5.length(),rect);
        heights[4]=(rect.bottom+rect.top)/2;

        paint2.getTextBounds(text6,0,text6.length(),rect);
        heights[5]=(rect.bottom+rect.top)/2;

        canvas.drawText(text1, 100, middle-heights[0], paint2);
        canvas.drawText(text2, 200, middle-heights[1], paint2);
        canvas.drawText(text3, 300, middle-heights[2], paint2);
        canvas.drawText(text4, 400, middle-heights[3], paint2);
        canvas.drawText(text5, 500, middle-heights[4], paint2);
        canvas.drawText(text6, 600, middle-heights[5], paint2);
    }
}