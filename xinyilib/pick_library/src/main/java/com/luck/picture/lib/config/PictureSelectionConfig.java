...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public int customCameraCoverType = Configuration.COVERTYPE_NONE;
    public String customCameraMessage = null;
    public boolean customCameraScreenPortait = true;
    public int customCameraCameraFace = Configuration.CAMERA_FACE_REAR;
    public boolean customCameraSupportSetting = false;
    @Configuration.MediaQuality
    public int customCameraMediaQuality = -1;
    @Configuration.MediaAction
    public int customCameraMediaAction = -1;
    public boolean customCameraSupportSwitchFace = true;
    public boolean customCameraSupportPreview = true;
    public String customCameraMediaPath ;
    public String customCameraMediaName  ;
    ...
    private void reset() {
        ...
        customCameraCoverType = Configuration.COVERTYPE_NONE;
        customCameraMessage = null;
        customCameraScreenPortait = true;
        customCameraCameraFace = Configuration.CAMERA_FACE_REAR;
        customCameraSupportSetting = false;
        customCameraMediaQuality = -1;
        customCameraMediaAction = -1;
        customCameraSupportSwitchFace = true;
        customCameraSupportPreview = true;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.rootPathDir);
        ...
        dest.writeInt(this.customCameraCoverType);
        dest.writeString(this.customCameraMessage);
        dest.writeByte(this.customCameraScreenPortait ? (byte) 1 : (byte) 0);
        dest.writeInt(this.customCameraCameraFace);
        dest.writeByte(this.customCameraSupportSetting ? (byte) 1 : (byte) 0);
        dest.writeInt(this.customCameraMediaQuality);
        dest.writeInt(this.customCameraMediaAction);
        dest.writeByte(this.customCameraSupportSwitchFace ? (byte) 1 : (byte) 0);
        dest.writeByte(this.customCameraSupportPreview ? (byte) 1 : (byte) 0);
        dest.writeString(this.customCameraMediaPath);
        dest.writeString(this.customCameraMediaName);
    ...
    protected PictureSelectionConfig(Parcel in) {
        ...
        this.rootPathDir = in.readString();
        ...
        this.customCameraCoverType = in.readInt();
        this.customCameraMessage = in.readString();
        this.customCameraScreenPortait = in.readByte() != 0;
        this.customCameraCameraFace = in.readInt();
        this.customCameraSupportSetting = in.readByte() != 0;
        this.customCameraMediaQuality = in.readInt();
        this.customCameraMediaAction = in.readInt();
        this.customCameraSupportSwitchFace = in.readByte() != 0;
        this.customCameraSupportPreview = in.readByte() != 0;
        this.customCameraMediaPath = in.readString();
        this.customCameraMediaName = in.readString();
