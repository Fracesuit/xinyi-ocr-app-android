...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel setCustomCameraCoverType(@Configuration.CoverType int customCameraCoverType) {
        selectionConfig.customCameraCoverType = customCameraCoverType;
        return this;
    }

    public PictureSelectionModel setCustomCameraMessage(@NonNull String customCameraMessage) {
        selectionConfig.customCameraMessage = customCameraMessage;
        return this;
    }

    public PictureSelectionModel setCustomCameraScreenPortait(boolean customCameraScreenPortait) {
        selectionConfig.customCameraScreenPortait = customCameraScreenPortait;
        return this;
    }

    public PictureSelectionModel setCustomCameraCameraFace(@Configuration.CameraFace int customCameraCameraFace) {
        selectionConfig.customCameraCameraFace = customCameraCameraFace;
        return this;
    }

    public PictureSelectionModel setCustomCameraSupportSetting(boolean customCameraSupportSetting) {
        selectionConfig.customCameraSupportSetting = customCameraSupportSetting;
        return this;
    }

    public PictureSelectionModel setCustomCameraMediaQuality(@Configuration.MediaQuality int customCameraMediaQuality) {
        selectionConfig.customCameraMediaQuality = customCameraMediaQuality;
        return this;
    }

    public PictureSelectionModel setCustomCameraSupportSwitchFace(boolean customCameraSupportSwitchFace) {
        selectionConfig.customCameraSupportSwitchFace = customCameraSupportSwitchFace;
        return this;
    }

    public PictureSelectionModel setCustomCameraSupportPreview(boolean customCameraSupportPreview) {
        selectionConfig.customCameraSupportPreview = customCameraSupportPreview;
        return this;
    }

    public PictureSelectionModel setRootPathDir(String rootPathDir) {
        selectionConfig.rootPathDir = rootPathDir;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        if (this.selectionConfig.customCameraCoverType == Configuration.COVERTYPE_RECTANGLE && this.selectionConfig.enableCrop) {
