...
import com.camera.internal.utils.ImageLoader;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mediaAction == MediaAction.ACTION_VIDEO) {
            ...
            String mimeType = PhotoUtils.getMimeType(previewFilePath);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.confirm_media_result) {
            ...
            setResult(RESULT_CANCELED, resultIntent);
            finish();
            ActivityUtils.finishActivity(CameraFragmentMainActivity.class);
        }
