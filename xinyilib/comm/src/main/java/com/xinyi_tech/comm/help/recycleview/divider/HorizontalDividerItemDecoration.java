...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        private Builder margin(final int leftMargin, final int rightMargin) {
        ...
        private Builder margin(int horizontalMargin) {
            return margin(horizontalMargin, horizontalMargin);
        }

        private Builder marginResId(@DimenRes int leftMarginId, @DimenRes int rightMarginId) {
