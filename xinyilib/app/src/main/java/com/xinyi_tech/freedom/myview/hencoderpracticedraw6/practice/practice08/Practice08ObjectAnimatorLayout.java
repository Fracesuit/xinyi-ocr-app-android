package com.xinyi_tech.freedom.myview.hencoderpracticedraw6.practice.practice08;
    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator progress = ObjectAnimator.ofFloat(view, "progress", 0, 100);
                progress.setInterpolator(new FastOutSlowInInterpolator());
