package com.xinyi_tech.freedom.myview.hencoderpracticedraw5.practice;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
          ...
          //  Rect clipBounds = canvas.getClipBounds();
            canvas.concat(getImageMatrix());//这句话 主要是 获取图片的具体位置
          //  XinYiLog.e("clipBounds" + clipBounds.left);
