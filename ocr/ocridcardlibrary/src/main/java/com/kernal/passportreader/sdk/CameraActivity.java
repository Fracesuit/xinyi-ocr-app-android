	...
	protected void onStart() {
		...
		switch (nMainIDX) {
			...
			case 2:
				...
				break;
			case 4:
				tv_camera_doctype.setText(getString(R.string.Interim_ID_card));
				break;
			...
			case 1001:
				...
				break;
			case 16:
				tv_camera_doctype.setText(getString(R.string.Household_Register));
				break;
			case 14:
			...
			case 1012:
				...
				break;
			case 1013:
				tv_camera_doctype.setText(getString(R.string.Shenzhen_Resident_Permit));
				break;
			...
			case 7:
				tv_camera_doctype
						.setText(getString(R.string.ChineseOfficer));
				break;
			default:
				break;
		}
				...
				if (!isTakePic) {
					...
					if (nMainIDX == 2 ||nMainIDX ==1013 || nMainIDX == 22 || nMainIDX == 1030
						...
						if (rotation == 90 || rotation == 270) {
							...
							top = (int) ((((float) (height - 0.41004673 * width) / 2) - (cameraParametersUtils.surfaceHeight - height) * 0.5) / scale);
							right = (int) ((0.85 * width - ((width - cameraParametersUtils.surfaceWidth) * 0.5)) / scale);
							bottom = (int) ((((float) (height + 0.41004673 * width) / 2) - (cameraParametersUtils.surfaceHeight - height) * 0.5) / scale);
						...
						if (rotation == 90 || rotation == 270) {
							...
							// landscape mode
							left = (int) ((0.2 * width - ((width - cameraParametersUtils.surfaceWidth) * 0.5)) / scale);
							top = (int) ((((float) (height - 0.45 * width) / 2) - (cameraParametersUtils.surfaceHeight - height) * 0.5) / scale);
							right = (int) ((0.85 * width - ((width - cameraParametersUtils.surfaceWidth) * 0.5)) / scale);
							bottom = (int) ((((float) (height + 0.45 * width) / 2) - (cameraParametersUtils.surfaceHeight - height) * 0.5) / scale);
							recogBinder.SetROI(left, top, right, bottom);// Paramater reservation
