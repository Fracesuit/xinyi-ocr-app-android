...
public abstract class BaseListDialogFragment<A extends BaseQuickAdapter<T, ? extends BaseViewHolder>, T, P extends BasePresenter>
        extends BaseDialogFragment<P> implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    //请求
    ...
    protected int getLayoutId() {
        return com.xinyi_tech.comm.R.layout.comm_fragment_baselist;
    }
    ...
    protected void initView(View view) {
        recyclerview = view.findViewById(com.xinyi_tech.comm.R.id.recyclerview);
        mRefreshLayout = view.findViewById(com.xinyi_tech.comm.R.id.swiperefreshlayout);
        initRefreshLayout();
        initRecyclerView();

        notdataview = activity.getLayoutInflater().inflate(com.xinyi_tech.comm.R.layout.comm_empty_view, (ViewGroup) recyclerview.getParent(), false);
        errorview = activity.getLayoutInflater().inflate(com.xinyi_tech.comm.R.layout.comm_error_view, (ViewGroup) recyclerview.getParent(), false);
    }

    private void initRefreshLayout() {
        mRefreshLayout.setColorSchemeResources(com.xinyi_tech.comm.R.color.comm_pink, com.xinyi_tech.comm.R.color.comm_green, com.xinyi_tech.comm.R.color.comm_amber,
                com.xinyi_tech.comm.R.color.comm_red, com.xinyi_tech.comm.R.color.comm_blue, com.xinyi_tech.comm.R.color.comm_yellow);
    ...
    private void initRecyclerView() {
        ...
        baseListAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                BaseListDialogFragment.this.onItemClick(baseListAdapter.getItem(position), position);
            }
        });
