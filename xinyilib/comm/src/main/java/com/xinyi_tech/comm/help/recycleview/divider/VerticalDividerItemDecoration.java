package com.xinyi_tech.comm.help.recycleview.divider;
...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
     ...
     */
    private interface MarginProvider {
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        private Builder margin(final int topMargin, final int bottomMargin) {
        ...
        private Builder marginResId(@DimenRes int topMarginId, @DimenRes int bottomMarginId) {
            return margin(mResources.getDimensionPixelSize(topMarginId),
                    mResources.getDimensionPixelSize(bottomMarginId));
        }

        private Builder marginResId(@DimenRes int verticalMarginId) {
            return marginResId(verticalMarginId, verticalMarginId);
        }

        private Builder marginProvider(MarginProvider provider) {
