...
import com.camera.internal.utils.ImageSaver;
...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener>
    ...
    @Override
    public void openCamera(File outputPath, String cameraId, final CameraOpenListener<String, TextureView.SurfaceTextureListener> cameraOpenListener) {
    ...
    @Override
    public void startVideoRecord(final CameraVideoListener cameraVideoListener) {
