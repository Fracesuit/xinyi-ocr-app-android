package com.xinyi_tech.freedom.pick.pictureselector;
...
import com.xinyi_tech.freedom.pick.pictureselector.adapter.GridImageAdapter;
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(PhotoActivity.this)
                        ...
                        .setRootPathDir(SDCardUtils2.getExternalPrivateCache().getAbsolutePath())
                        .setCustomCameraScreenPortait(false)
                        // .setCustomCameraCoverRes(R.drawable.addimg_1x)
                        // .setCustomCameraCoverType(Configuration.COVERTYPE_FACE)
                        .setCustomCameraCoverType(Configuration.COVERTYPE_RECTANGLE)
                        .setCustomCameraSupportSetting(false)
                        .isZoomAnim(true)// 图片列表点击 缩放效果 默认true
                        .imageFormat(".jpg")// 拍照保存图片格式后缀,默认jpeg
