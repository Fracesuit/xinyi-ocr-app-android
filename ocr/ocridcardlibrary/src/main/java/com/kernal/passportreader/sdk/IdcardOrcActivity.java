...
public class IdcardOrcActivity extends Activity implements OnClickListener {
 ...
 */
            intent = new Intent(IdcardOrcActivity.this, CameraActivity.class);
            if (Build.VERSION.SDK_INT >= 23) {
                CheckPermission checkPermission = new CheckPermission(this);
                if (checkPermission.permissionSet(PERMISSION)) {
                    PermissionActivity.startActivityForResult(this, 0,
...
// Phote Album
    ...
    private void activationProgramOpera() {
        ...
        dialog = new Builder(IdcardOrcActivity.this)
                .setView(view)
                .setPositiveButton(getString(R.string.online_activation),
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                if (isNetworkConnected(IdcardOrcActivity.this)) {
                                    if (isWifiConnected(IdcardOrcActivity.this)
                                            || isMobileConnected(IdcardOrcActivity.this)) {
                                        startAuthService();
                                        dialog.dismiss();
                                    } else if (!isWifiConnected(IdcardOrcActivity.this)
                                            && !isMobileConnected(IdcardOrcActivity.this)) {
                                        Toast.makeText(
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 9 && resultCode == Activity.RESULT_OK) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (checkPermission.permissionSet(PERMISSION)) {
                    ...
                    public void run() {
                        ...
                        Intent recogIntent = new Intent(IdcardOrcActivity.this,
                                RecogService.class);
            ...
            ActivityRecogUtils.goShowResultActivity(IdcardOrcActivity.this, resultMessage,0,selectPath,selectPath.substring(0,selectPath.indexOf(".jpg"))+ "Cut.jpg");
        }
    }
            ...
            if(recogBinder!=null) {
                        ...
                        try {
                            ...
                            if (resultMessage.ReturnAuthority == 0
                                ...
                                Intent intent = new Intent(IdcardOrcActivity.this,
...
//                            Looper.loop();
    ...
    private void startAuthService() {
        ...
        Intent authIntent = new Intent(IdcardOrcActivity.this, AuthService.class);
