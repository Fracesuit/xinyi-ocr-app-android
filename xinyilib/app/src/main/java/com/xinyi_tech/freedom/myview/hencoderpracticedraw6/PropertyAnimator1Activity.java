package com.xinyi_tech.freedom.myview.hencoderpracticedraw6;
...
public class PropertyAnimator1Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale6, R.string.title_scale, R.layout.practice_scale6));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_property_animator1	);
